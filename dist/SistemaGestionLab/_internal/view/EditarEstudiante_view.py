...
class EditarEstudiante_view:
    def __init__(self, root):
        ...
        self.root.title("Editar estudiante")
    ...
    def set_datos(self, datos):
        self.nombre_var.set(datos.get("nombre", ""))
        self.apellido_var.set(datos.get("apellido", ""))
        self.correo_var.set(datos.get("correo", ""))
        self.celular_var.set(datos.get("celular", ""))
        self.codigo_var.set(datos.get("codigo", ""))
        self.cedula_var.set(datos.get("cedula", ""))
        self.proyecto_var.set(datos.get("proyecto_nombre", ""))
